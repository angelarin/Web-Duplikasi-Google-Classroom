    ...
    <div class="container-fluid" style="width: 75%">
        ...
        <div class="row">
            ...
            <div class="card img-fluid" style="width:100%; border-radius: 10px; margin: auto;">
                <img class="card-img-top" src="img/img1.jpg" alt="Card image" style="width:100%; border-radius: 10px;">
                <div class="card-img-overlay">
                    <h4 class="card-title" style="color: white; font-size: 35px; margin-top: 130px; padding-left: 10px;">
                        <b>Kelas 10 WKWK Wajib</b>
                    </h4>
                    <p class="card-text" style="color: white; font-size: 20px; padding-left: 10px;">1</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9" style="width:100%; border-radius: 10px;">
                ...
                <div class="card" style="border-radius: 10px;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-1">
                                <img src="img/list-check-solid.svg" width="25px;">
                            </div>
                            <div class="col-md-10">
                                <h6>Karina Angela</h6>
                                <p>3 Mei</p>
