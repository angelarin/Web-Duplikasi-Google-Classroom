...
<head>
    ...
    <link rel="stylesheet" href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.1/animate.min.css')}}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top"
                    ...
                    <div class="col">
                        <ul style="justify-content: center" class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link active" href="/depansiswa/{{$id}}" style="color: black;">Forum</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/depansiswa/{{$id}}/haltugas" style="color: black;">Tugas Kelas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/depansiswa/{{$id}}/anggota" style="color: black;">Anggota</a>
                            </li>
                    </div>
